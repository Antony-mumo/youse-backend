...
import com.company.youse.services.CustomerService;
...
public class CustomerController {
    ...
    @RequestMapping(value = "/api/customer/signup", method = RequestMethod.POST /*, consumes = MediaType.MULTIPART_FORM_DATA_VALUE*/ )
